...
import ConfigEditorRenderer from "../shared/renderers/ConfigEditorRenderer";
...
import TunerRenderer from "../shared/renderers/TunerRenderer";
import VideoRenderer from "../shared/renderers/VideoRenderer";
import { UnitConversionPreset } from "../shared/units";
import ScrollSensor from "./ScrollSensor";
import Timeline from "./Timeline";
import ConfigEditorController from "./controllers/ConfigEditorController";
...
export default class Tabs {
  ...
  constructor() {
    ...
    this.FIXED_CONTROL_HEIGHTS.set(TabType.ConfigEditor, 0);
  ...
  addTab(type: TabType) {
    ...
    switch (type) {
      ...
      case TabType.Metadata:
        ...
        break;
      case TabType.Tuner:
        controller = new TunerController(controlsElement);
        renderer = new TunerRenderer(rendererElement, true);
        break;
      case TabType.ConfigEditor:
        controller = new ConfigEditorController();
        renderer = new ConfigEditorRenderer(rendererElement);
        break;
      // case TabType.Lines:
