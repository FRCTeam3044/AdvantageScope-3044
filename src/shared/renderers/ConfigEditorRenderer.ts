...
export default class ConfigEditorRenderer implements TabRenderer {
  ...
  constructor(content: HTMLElement) {
    ...
    this.WARNING_DIV = content.getElementsByClassName("ce-warning")[0] as HTMLElement;
    this.NO_DEPLOY_WARNING = content.getElementsByClassName("ce-warning")[1] as HTMLElement;
    this.FAILED_DEPLOY_WARNING = content.getElementsByClassName("ce-warning")[2] as HTMLElement;
    this.SUCCESS_WARNING = content.getElementsByClassName("ce-warning")[3] as HTMLElement;
